...
%% REseed
\path let \p1=(svrs_in_data_valid.east),\p2=(and5_start_reseed.in 5) in coordinate (east_svrs_reseed_in) at (\x1,\y2);
...
\path let \p1=(and5_start_reseed.in 1), \p2=(svrs_key_valid) in coordinate (loc_key_valid_to_reseed) at (\x1, \y2);
